    ...
    public function gethpaWithPatient()
{
    return $this->select('
            hpa.*, 
            patient.*, 
            penerimaan_hpa.id_hpa AS id_penerimaan,
            pemotongan_hpa.id_hpa AS id_pemotongan,
            pemprosesan_hpa.id_hpa AS id_pemprosesan,
            penanaman_hpa.id_hpa AS id_penanaman,
            pemotongan_tipis_hpa.id_hpa AS id_pemotongan_tipis,
            pewarnaan_hpa.id_hpa AS id_pewarnaan,
            pembacaan_hpa.id_hpa AS id_pembacaan,
            penulisan_hpa.id_hpa AS id_penulisan,
            pemverifikasi_hpa.id_hpa AS id_pemverifikasi,
            authorized_hpa.id_hpa AS id_authorized,
            pencetakan_hpa.id_hpa AS id_pencetakan,
            mutu_hpa.id_hpa AS id_mutu
        ')
