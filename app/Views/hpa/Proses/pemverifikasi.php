...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <h1>Daftar Pemverifikasi Histopatologi</h1>
                        ...
                        <?php if (!empty($pemverifikasiDatahpa)): ?>
                            ...
                            <?php foreach ($pemverifikasiDatahpa as $row): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?= $row['id_user_dokter_pembacaan_hpa'] == 1 ? 'dr. Vinna Chrisdianti, Sp.PA' : ($row['id_user_dokter_pembacaan_hpa'] == 2 ? 'dr. Ayu Tyasmara Pratiwi, Sp.PA' : '') ?>
                                    </td>
