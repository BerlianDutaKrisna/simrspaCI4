<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    $(".btn-cetak-stiker").on("click", function() {
      let id_hpa = $(this).data("id");
      let kode = $(this).data("kode");

      // Ambil jumlah slide terbaru
      let slide = parseInt($(`.jumlah-slide-input[data-id="${id_hpa}"]`).val(), 10);
      if (isNaN(slide) || slide < 1) {
        slide = 1;
      }

      console.log("Cetak stiker untuk ID:", id_hpa, "Jumlah Slide:", slide);
      ...
      <head>
        ...
        <style>
          ...
          .kode-hpa { font-size: 9pt; font-weight: bold; margin: 0.1mm 0; }
        ...
        <div class="label">
          <div class="inner-label">
            ...
            <div class="teks-label">
              ...
              <div class="kode-hpa">${kode}</div>
              ${slide > 1 ? `<div class="angka-romawi">${toRoman(i)}</div>` : ''}
            </div>
          </div>
        </div>`;
      }
