                        ...
                        <?php if (!empty($penulisanDatasrs)): ?>
                            ...
                            <?php foreach ($penulisanDatasrs as $row): ?>
                                <tr>
                                    ...
                                    <?php if (in_array($row['status_penulisan_srs'], ["Proses Penulisan", "Belum Penulisan"])): ?>
                                        <td>
                                            <a href="<?= esc(base_url('srs/edit_penulisan/' . esc($row['id_srs']) . '?redirect=index_penulisan_srs')) ?>"
                                                class="btn btn-warning btn-sm">
                                                <i class="fas fa-pen"></i> Detail
                                            </a>
                                        </td>
                                    <?php elseif ($row['status_penulisan_srs'] === "Selesai Penulisan"): ?>
                                        <td>
                                            <a href="<?= esc(base_url('srs/edit_penulisan/' . esc($row['id_srs']) . '?redirect=index_penulisan_hpa')) ?>"
