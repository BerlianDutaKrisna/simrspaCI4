        ...
        <tr>
            ...
            <td>
                <table width="500">
                    ...
                    <tr><td nowrap>Tanggal Terima</td><td>:</td><td>&nbsp; <?= isset($ihc['mulai_penerimaan_ihc']) ? date('d-m-Y H:i:s', strtotime($ihc['mulai_penerimaan_ihc'])) : '' ?></td></tr>
                    <tr><td nowrap>Tanggal Hasil</td><td>:</td><td>&nbsp; <?= isset($ihc['selesai_authorized_ihc']) ? date('d-m-Y H:i:s', strtotime($ihc['selesai_authorized_ihc'])) : '' ?></td></tr>
                </table>
            </td>
        </tr>
        <tr>
