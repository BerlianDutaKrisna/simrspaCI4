...
class Autorized_fnab extends Migration
{
    public function up()
    {
        $this->forge->addField([
        ...
        $this->forge->createTable('autorized_fnab');
    }

    public function down()
    {
        $this->forge->dropForeignKey('autorized_fnab', 'id_fnab');
        $this->forge->dropForeignKey('autorized_fnab', 'id_user_autorized');
        $this->forge->dropForeignKey('autorized_fnab', 'id_user_dokter_autorized');
        $this->forge->dropTable('autorized_fnab');
    }
}
