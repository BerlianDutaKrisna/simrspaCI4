...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form action="<?= base_url('mutu_srs/update') ?>" method="POST">
            <input type="hidden" name="id_mutu_srs" value="<?= $mutuData['id_mutu_srs'] ?>">

            <div class="row mb-3">
                <!-- Kode SRS -->
                <div class="col-md-6">
                    <label for="kode_srs">Kode SRS:</label>
                    <p><?= $mutuData['kode_srs'] ?></p>
                </div>
                <!-- Nama Pasien -->
                <div class="col-md-6">
            ...
            <div class="row mb-3">
                <!-- Total Nilai Mutu -->
                <div class="col-md-6">
                    <label for="total_nilai_mutu_srs">Total Nilai Mutu:</label>
                    <input type="text" class="form-control" id="total_nilai_mutu_srs" name="total_nilai_mutu_srs" value="<?= $mutuData['total_nilai_mutu_srs'] ?>" readonly>
                </div>
            </div>
