...
class PemotonganTipis extends BaseController
{
    ...
    public function proses_pemotongan_tipis()
    {
        ...
        try {
            ...
            foreach ($selectedIds as $id) {
                ...
                $this->processAction($action, $id_pemotongan_tipis_hpa, $id_hpa, $id_user, $id_mutu_hpa, $indikator_3, $total_nilai_mutu_hpa);
            }
    ...
    private function processAction($action, $id_pemotongan_tipis_hpa, $id_hpa, $id_user, $id_mutu_hpa, $indikator_3, $total_nilai_mutu_hpa)
    {
