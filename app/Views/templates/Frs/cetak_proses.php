<script>
    ...
    <body>
        ...
        <table class="makroskopis-content-table">
            <tr>
                <td>Makroskopis</td>
                <td>Analis PA: <?= $pemotongan['analis_nama'] ?? '' ?> | Waktu Pemotongan: <?= isset($pemotongan['mulai_pemotongan_frs']) ? date('H:i d-m-Y', strtotime($pemotongan['mulai_pemotongan_frs'])) : ''; ?></td>
            </tr>
            <tr>
        ...
        <table class="mikroskopis-content-table">
            <tr>
                <td>Mikroskopis</td>
                <td>Dokter PA: <?= $pemotongan['dokter_nama'] ?? '' ?> | Waktu pembacaan: <?= isset($pembacaan['mulai_pembacaan_frs']) ? date('H:i d-m-Y', strtotime($pembacaan['mulai_pembacaan_frs'])) : ''; ?></td>
            </tr>
            <tr>
