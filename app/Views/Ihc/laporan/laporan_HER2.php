...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <div class="row justify-content-center mb-3">
            <div class="col-auto">
                <h5 class="text-center font-weight-bold">Kontrol Positif HER2</h5>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-auto">
                <a href="<?= base_url('ihc/laporan_HER2'); ?>" class="btn btn-light btn-icon-split m-2">
                    <span class="text"><b style="color: dark;">HER2</b></span>
