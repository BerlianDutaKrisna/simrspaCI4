                        ...
                        <?php if (!empty($authorizedDatasrs)): ?>
                            ...
                            <?php foreach ($authorizedDatasrs as $row): ?>
                                <tr>
                                    ...
                                    <?php if (in_array($row['status_authorized_srs'], ["Proses Authorized", "Belum Authorized"])): ?>
                                        <td>
                                            <a href="<?= esc(base_url('srs/edit_print/' . esc($row['id_srs']) . '?redirect=index_authorized_srs')) ?>"
                                                class="btn btn-warning btn-sm">
                                                <i class="fas fa-eye"></i> Cek Verifikasi
                                            </a>
                                        </td>
                                    <?php elseif ($row['status_authorized_srs'] === "Selesai Authorized"): ?>
                                        <td>
                                            <a href="<?= esc(base_url('srs/edit_print/' . esc($row['id_srs']) . '?redirect=index_authorized_srs')) ?>"
