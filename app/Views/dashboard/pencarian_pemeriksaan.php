        ...
        <div class="row">
            ...
            <script>
                ...
                `;
                    ...
                    <a href="<?= site_url('hpa/register_hpa') ?>?norm_pasien=${norm}" class="btn btn-danger"><i class="fas fa-plus-square"></i> HPA</a>
                    <a href="<?= site_url('frs/register_frs') ?>?norm_pasien=${norm}" class="btn btn-primary"><i class="fas fa-plus-square"></i> FNAB</a>
                    <a href="<?= site_url('srs/register_srs') ?>?norm_pasien=${norm}" class="btn btn-success"><i class="fas fa-plus-square"></i> SRS</a>
                    <a href="<?= site_url('ihc/register_ihc') ?>?norm_pasien=${norm}" class="btn btn-warning"><i class="fas fa-plus-square"></i> IHC</a>
