    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form id="form-frs" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="pemeriksaan" value="<?= isset($frs['tindakan_spesimen']) ? esc($frs['tindakan_spesimen']) : '' ?>">
                <input type="hidden" name="idpasien" value="<?= isset($frs['id_pasien']) ? (int) $frs['id_pasien'] : '' ?>">
                <input type="hidden" name="norm" value="<?= isset($frs['norm_pasien']) ? esc($frs['norm_pasien']) : '' ?>">
                <input type="hidden" name="nama" value="<?= isset($frs['nama_pasien']) ? esc($frs['nama_pasien']) : '' ?>">
