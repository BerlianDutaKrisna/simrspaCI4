<?php
$dokter_pemeriksa = '';
if (($frs['id_user_dokter_penerimaan_frs'] ?? '') === "1") {
    $dokter_pemeriksa = "dr. Vinna Chrisdianti, Sp.PA";
} elseif (($frs['id_user_dokter_penerimaan_frs'] ?? '') === "2") {
    $dokter_pemeriksa = "dr. Ayu Pratiwi, Sp.PA";
}
...
<script>
    function cetakProses() {
        ...
        var dokter = document.getElementById('dokter_pemeriksa') ?
            document.getElementById('dokter_pemeriksa').value :
            '';

        var dokter_nama = "(____________________)";
        ...
        var hubungan_dengan_pasien = document.getElementById('hubungan_dengan_pasien') ?
            document.getElementById('hubungan_dengan_pasien').value :
            '____________________';

        var jenis_kelamin_hubungan_pasien = document.getElementById('jenis_kelamin_hubungan_pasien') ?
            document.getElementById('jenis_kelamin_hubungan_pasien').value :
            '';

        var usia_hubungan_pasien = document.getElementById('usia_hubungan_pasien') ?
            document.getElementById('usia_hubungan_pasien').value :
            '';
...
<body>
    <div class="container">
        ...
        <table>
            ...
            <tr>
                <td colspan="2">
                    Dengan ini menyatakan bahwa saya telah menerima informasi sebagaimana di atas yang saya beri tanda tangan/paraf di kolom kanannya, dan telah memahaminya
                </td>
        ...
        <table>
            ...
            <tr>
                <td colspan="2">
                    Dengan ini menyatakan setuju untuk dilakukan tindakan <?= esc($frs['tindakan_spesimen'] ?? '') ?> terhadap saya/ _______________ saya*
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <br>
                    Saya bertanggung jawab atas segala akibat yang mungkin timbul sebagai akibat dilakukan tindakan kedokteran tersebut.
                </td>
            </tr>
