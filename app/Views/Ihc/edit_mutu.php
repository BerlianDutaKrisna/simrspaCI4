...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form action="<?= base_url('mutu_ihc/update') ?>" method="POST">
            <input type="hidden" name="id_mutu_ihc" value="<?= $mutuData['id_mutu_ihc'] ?>">

            <div class="row mb-3">
                <!-- Kode IHC -->
                <div class="col-md-6">
                    <label for="kode_ihc">Kode IHC:</label>
                    <p><?= $mutuData['kode_ihc'] ?></p>
                </div>
                <!-- Nama Pasien -->
                <div class="col-md-6">
            ...
            <div class="row mb-3">
                <!-- Total Nilai Mutu -->
                <div class="col-md-6">
                    <label for="total_nilai_mutu_ihc">Total Nilai Mutu:</label>
                    <input type="text" class="form-control" id="total_nilai_mutu_ihc" name="total_nilai_mutu_ihc" value="<?= $mutuData['total_nilai_mutu_ihc'] ?>" readonly>
                </div>
            </div>
